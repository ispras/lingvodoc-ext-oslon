...
public:
	...
	void AddDistibutionConditions()
	{
		...
		qry.AddCondition(L"Г", NULL, L"+ГУБ", QF_OBJECTONLYONCE, L"перед губными");
		...
		qry.AddCondition(L"С", L"+ПЕР", NULL, QF_OBJECTONLYONCE | QF_CONTEXTONLYONCE, L"после передних");
		qry.AddCondition(L"С", L"+ЦНТ", NULL, QF_OBJECTONLYONCE | QF_CONTEXTONLYONCE, L"после центральных");
		qry.AddCondition(L"С", L"+ЗАД", NULL, QF_OBJECTONLYONCE | QF_CONTEXTONLYONCE, L"после задних");
		qry.AddCondition(L"С", L"+ОГУ", NULL, QF_OBJECTONLYONCE | QF_CONTEXTONLYONCE, L"после огубленных");
